...
คุณได้รับ task ใหม่จาก Janie
ตอบเป็นภาษาไทย ไม่เกิน 4 ประโยค:
1. รับทราบ task
2. บอก approach ที่จะทำ (ละเอียดพอสมควร)
3. บอก deliverable ที่จะส่ง
4. บอก timeline หรือสิ่งที่ต้องการเพิ่ม (ถ้ามี)
ตรงประเด็น มืออาชีพ`
